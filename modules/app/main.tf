...
resource "null_resource" "ansible" {
  provisioner "remote-exec" {
    ...
    inline = [
      ...
      "ansible-pull -i localhost, -U https://github.com/raju-b71/expense-ansible expense.yml -e env=${var.env} -e role_name=${var.component} -e @common.json -e @${var.component}.json"
